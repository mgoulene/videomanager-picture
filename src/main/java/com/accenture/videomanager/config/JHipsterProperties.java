...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "vmpicture@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "vmpicture API";

        private String description = "vmpicture API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "vmpicture";
